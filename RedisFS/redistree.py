...
class RedisTree:
    ...
    def __init__(self, redis_host='localhost', redis_port=6379, redis_db=0):
        ...
        # Initialize the file system with a root node
        self.init_fs()
    ...
    def init_fs(self):
        ...
        self.create_node({'name': 'root'}, self.ROOT_NODE)
    ...
    def get_node_at_path(self, *args, **kwargs):
        """Return the NODE uid componant of real_node."""
        return self.real_node(*args, **kwargs)[1]

    def get_real_path(self, *args, **kwargs):
        """Return the path componant of real_node."""
